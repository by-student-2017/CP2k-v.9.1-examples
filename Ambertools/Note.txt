...
15. mpirun -np 8 sander.MPI -O -i sander_min.in -o min_classical.out -p system.parm7 -c system.rst7 -r system.min.rst7
16. mpirun -np 8 sander.MPI -O -i sander_heat.in -o heat_classical.out -p system.parm7 -c system.min.rst7 -r system.heat.rst7 -x system.heat.nc
17. mpirun -np 8 sander.MPI -O -i sander_equil.in -o equil_classical.out -p system.parm7 -c system.heat.rst7 -r system.equil.rst7 -x system.equil.nc

# Analysis of the MM equilibration simulation
18. $AMBERHOME/bin/process_mdout.perl heat_classical.out equil_classical.out

# Adding Lennard-Jones parameters using parmed
19. $AMBERHOME/bin/parmed system.parm7
  printDetails @4686
...
Or
  ...
  outparm system_LJ_mod.parm7
  quit
20. $AMBERHOME/bin/parmed system.parm7 -i parmed.in
  trajin system.equil.rst7
  autoimage
  trajout system.equil0.rst7 inpcrd
  go 
  quit
21. $AMBERHOME/bin/cpptraj -p system_LJ_mod.parm7

Running a QM/MM monitorisation run
22. mpirun -np 8 cp2k -i cp2k_qmmm_equil.inp | tee cp2k_qmmm_equil.out
#------------------------------------------------------------------------------------------
