...
- Tersoff also takes into account the universal potential and the second moment approximation. In light of these results for silicon, it is not surprising that Tersoff published parameters for amorphous carbon in a 1988 paper.
