...
- NIST has presented the Tersoff potential for Fe, Zn, In, and Al-C-Ti, which shows the wide range of applicability of the Tersoff potential. gamma -> beta, beta -> gamma, and lambda3=0.0 (m can have any value for lambda3=0.0).
